{{-- resources/views/dogs/create.blade.php --}}
<x-app-layout>
    @push('styles')
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="text-2xl font-semibold">Add a Dog</h2>
        </div>
    </x-slot>
    ...
    <div class="min-h-[calc(100vh-4rem)] py-8 px-4 sm:px-6 lg:px-8"
        ...
        <div class="max-w-5xl mx-auto">
            <div class="rounded-3xl ring-1 ring-black/5 shadow-lg p-6 md:p-10"
                ...
                <div class="mb-6">
                    <h1 class="text-3xl font-extrabold">New Dog Profile</h1>
                    <p class="mt-1 text-sm" style="color: {{ $KK_NAVY }}B3">
                        Enter the dog’s details to create a new profile in the system.
                    </p>
                </div>
