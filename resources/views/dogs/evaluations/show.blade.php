...
<div class="wrap">
        ...
        <div class="card">
            ...
            <div class="bd">
                @foreach($displayScores as $label => $value)
                    ...
                    <div class="score">
                        <div class="small" style="margin-bottom:6px; color:#334155; font-weight:600;">
                            {{ $label }}
                        </div>
                        <div class="bar">
                            <span style="width: {{ $width }}%; background: {{ $clr }};"></span>
                        </div>
                        <div class="small"
                             style="text-align:right; color: {{ $clr }}; margin-top:4px; font-weight:700;">
                            {{ $txt }}
                        </div>
                    </div>
    ...
    <div class="card" style="margin-top:16px;">
        ...
        <div class="bd" style="padding:0;">
            @if (empty($answers))
                <div class="small" style="padding:12px 12px 16px; color:#334155;">
